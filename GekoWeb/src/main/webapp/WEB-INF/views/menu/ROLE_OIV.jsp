...
<security:authorize access="hasRole('ROLE_OIV')">
...
<fieldset>
<legend>Parametri della Sessione OIV </legend>
...
<div class="navbar navbar-default" >
	...
	<ul class= "dropdown-menu">	
     	<li> 
         <a href="oivProg/listPianificazioneApicaleIncaricoOiv/${menu.anno}/${menu.incaricoApicaleAmm_ne.idIncarico}">
	...
	<ul class= "dropdown-menu">	
         ...
         <li> 
         <a href="oivRend/listRendicontazioneIncaricoApicaleOiv/${menu.anno}/${menu.incaricoApicaleAmm_ne.idIncarico}">
	...
	<ul class= "dropdown-menu">	
     	...
     	<li><a href="oivValut/listValutazioneIncaricoApicaleOiv/${menu.anno}/${menu.incaricoApicaleAmm_ne.idIncarico}">
		    Visualizza valutazione Dirigente incarico: ${menu.incaricoApicaleAmm_ne.stringa} / ${menu.anno}</a>
	    </li>
     	<li><a href="oivValut/modifyValutazioneIncaricoApicaleOiv/${menu.anno}/${menu.incaricoApicaleAmm_ne.idIncarico}">
		    Modifica valutazione Dirigente incarico: ${menu.incaricoApicaleAmm_ne.stringa} / ${menu.anno}</a>
	    </li>
	    
     	<li> 
     	<a href="oivValutPdf/pdfValutazioneIncaricoOivConCalcolo/${menu.anno}/${menu.incaricoApicaleAmm_ne.idIncarico}">
         Pdf Valutazione con calcolo: ${menu.incaricoApicaleAmm_ne.stringa} / ${menu.anno}</a>
     	</li>
	...
	<li class= "dropdown">
        <a href ="#" class="dropdown-toggle" data-toggle="dropdown">Indicazioni Oiv<b class="caret"></b></a>
		<ul class= "dropdown-menu">	
		
	 
	  <li>
	    <label class="extralarge"></label>
	    <a href="oivRend/listIndicazioniIncaricoApicaleOiv/${menu.anno}/${menu.incaricoApicaleAmm_ne.idIncarico}">
	    Visualizza le indicazioni incarico:  ${menu.incaricoApicaleAmm_ne.stringa} / ${menu.anno}</a>
	  </li>
	
		<li>
	    <label class="extralarge"></label>
	    <a href="oivRend/modifyIndicazioniIncaricoApicaleOiv/${menu.anno}/${menu.incaricoApicaleAmm_ne.idIncarico}">
	    Modifica le indicazioni incarico:  ${menu.incaricoApicaleAmm_ne.stringa} / ${menu.anno}</a>
	  </li>     
</ul>  	
</li>
</ul>
