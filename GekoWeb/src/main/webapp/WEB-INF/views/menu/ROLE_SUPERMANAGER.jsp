...
<security:authorize access="hasRole('SUPERMANAGER')">
...
<fieldset>
<legend>Parametri della Sessione SUPERMANAGER</legend> 
...
<div class="navbar navbar-default" >
	<div class="container-fluid" >
		...
		<ul class="dropdown-menu">
			...
			<li> <a href="superDirigente/modifyProgrammazioneIncarico/${menu.anno}/${menu.incarico.idIncarico}">
			Gestisci programmazione incarico: ${menu.incarico.stringa} per ${menu.anno}</a></li>
			<li class="divider"></li>
		
            <li> <a href="superDirigente/listProgrammazioneIncarico/${menu.anno}/${menu.incarico.idIncarico}">
            Visualizza programmazione incarico: ${menu.incarico.stringa} per ${menu.anno}</a></li>
            
            <li><a href="superDirigente/listCompattaProgrammazioneIncarico/${menu.anno}/${menu.incarico.idIncarico}">
        	Visualizza progr. compatta incarico: ${menu.incarico.stringa} per ${menu.anno}</a></li>
            
		 	  
        	<li class="divider"></li>
        	  
	        <li><a href="superDirigentePdf/pdfPianificazioneIncarico/${menu.anno}/${menu.incarico.idIncarico}">
	    	Pdf programmazione incarico: ${menu.incarico.stringa} per ${menu.anno}</a></li> 
	    	
	    	<li class="divider"></li>
	    	
	      	
	      	<li><a href="superDirigente/associaPianificazioneStrategicaIncarico/${menu.anno}/${menu.incarico.idIncarico}">
	    	Associa ad Obiettivi Strategici Programmazione incarico: ${menu.incarico.stringa} / ${menu.anno}</a></li> 
	    
	    	<li class="divider"></li>
	    	<li> <a href="superDirigente/sintesiPianificazioneDipartimentoManager/${menu.anno}/${menu.incaricoApicaleDept.idIncarico}">
	    	Sintetizza obiettivi dirigenziali incarico: ${menu.incaricoApicaleDept.stringa} / ${menu.anno}</a></li> 
    
    		<li class="divider"></li>
    		<li><a href="superDirigente/listPianificazioneAltroIncaricoManager/${menu.anno}/${menu.incaricoDept.idIncarico}">
...
<li class= "dropdown">
		...
		<ul class= "dropdown-menu">	
			<li> <a href="superDirigente/modifyRendicontazioneIncaricoManager/${menu.anno}/${menu.incarico.idIncarico}">
			Aggiorna rendicontazione incarico: ${menu.incarico.stringa} / ${menu.anno}</a> </li>
			
			<li> <a href="superDirigente/listRendicontazioneIncaricoManager/${menu.anno}/${menu.incarico.idIncarico}">
			Visualizza rendicontazione incarico: ${menu.incarico.stringa} / ${menu.anno}</a></li>
			
			<li class="divider"></li>
        	  
	        <li><a href="superDirigentePdf/pdfRendicontazioneIncaricoManager/${menu.anno}/${menu.incarico.idIncarico}">
	    	Pdf rendicontazione incarico: ${menu.incarico.stringa} / ${menu.anno}</a></li> 
			
			<li class="divider"></li>
			
			<li> <a href="superDirigente/scadenze/${menu.anno}/${menu.incarico.idIncarico}">
			Visualizza scadenzario incarico: ${menu.incarico.stringa} / ${menu.anno}</a></li>
			
			<li class="divider"></li>
			
			<li> <a href="superDirigente/listRendicontazioneDipartimentaleManager/${menu.anno}/${menu.incaricoApicaleDept.idIncarico}">
			    Visualizza la Rendicontazione Dipartimentale: ${menu.incaricoApicaleDept.stringa} / ${menu.anno}</a>
			</li> 
			<li><a href="superDirigente/listRendicontazioneAltroIncaricoManager/${menu.anno}/${menu.incaricoDept.idIncarico}">
...
<li class= "dropdown">
		...
		<li><a href="superDirigente/listDipendentiAssegnazioniValutazione/${menu.anno}/${menu.incarico.idIncarico}">
        Visualizza Valutazione Comparto incarico: ${menu.incarico.stringa} / ${menu.anno}</a></li>
        
    	<li><a href="superDirigentePdf/pdfValutazioneStrutturaManager/${menu.anno}/${menu.incarico.idIncarico}">
        Crea Pdf Valutazione Comparto incarico: ${menu.incarico.stringa} / ${menu.anno}</a></li>
    
    	<li><a href="superDirigente/modifyDipendentiAssegnazioniValutazione/${menu.anno}/${menu.incarico.idIncarico}">
...
<li class= "dropdown">
        <a href ="#" class="dropdown-toggle" data-toggle="dropdown">Direttive Presidenziali<b class="caret"></b></a>
		<ul class= "dropdown-menu">	
		<li><a href="superDirigente/listDirettivaManager/${menu.anno}">
	    Visualizza la Direttiva ${menu.anno}</a></li> 
		</ul>
</li>
...
<li class= "dropdown">
		...
		<li><a href="superDirigente/listDipendenti/${menu.anno}/${menu.incarico.idIncarico}">
