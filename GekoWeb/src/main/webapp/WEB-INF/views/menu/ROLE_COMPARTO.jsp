...
<head>
	...
	<title>Geko - Menu Dipendente Comparto</title>	
...
<security:authorize access="hasRole('COMPARTO')">
...
<fieldset>
<legend>Parametri della Sessione COMPARTO</legend> 
...
<div class="navbar navbar-default" >
	<div class="container-fluid" >
		...
		<ul class="dropdown-menu">
			...
			<li><a href="comparto/listCompattaProgrammazioneIncarico/${menu.anno}/${menu.incarico.idIncarico}">
        	Visualizza programmazione dirigenziale per incarico: ${menu.incarico.stringa} per ${menu.anno}</a></li>           
			
			<li class="divider"></li>
	        
	    	
	    	<li><a href="comparto/modifyCompartoProgrammazione/${menu.anno}/${menu.incarico.idIncarico}">
        	Gestisci progr. comparto incarico: ${menu.incarico.stringa} per ${menu.anno}</a></li> 
	    	<li><a href="comparto/listCompartoProgrammazione/${menu.anno}/${menu.incarico.idIncarico}">
        	Visualizza progr. comparto incarico: ${menu.incarico.stringa} per ${menu.anno}</a></li>        	
        		
        	
        	<!--  
        	<a href="dirigentePdf/pdfProgrammazioneCompartoManager/${menu.anno}/${menu.incarico.idIncarico}">
        	Pdf progr. Comparto incarico: ${menu.incarico.stringa} per ${menu.anno}</a>
        	-->
        	<li><a href="comparto/listProgrammazioneIncarico/${menu.anno}/${menu.incarico.idIncarico}">
        	Pdf progr. Comparto incarico (sarà disponibile con la versione 1.4.1 entro la data del 30/10/2019)</a></li>
...
<li class= "dropdown">
		...
		<ul class= "dropdown-menu">	
			<li> <a href="comparto/modifyRendicontazioneIncaricoManager/${menu.anno}/${menu.incarico.idIncarico}">
			Aggiorna rendicontazione incarico: ${menu.incarico.stringa} / ${menu.anno}</a> </li>
			
			<li> <a href="comparto/listRendicontazioneIncaricoManager/${menu.anno}/${menu.incarico.idIncarico}">
...
<li class= "dropdown">
		...
		<li><a href="comparto/listDipendentiAssegnazioniValutazione/${menu.anno}/${menu.incarico.idIncarico}">
        Visualizza Valutazione Comparto incarico: ${menu.incarico.stringa} / ${menu.anno}</a></li>
        
    	<li><a href="compartoPdf/pdfValutazioneStrutturaManager/${menu.anno}/${menu.incarico.idIncarico}">
