...
<title>Maschera Creazione Risultato Atteso</title>
...
<h3 > Nuovo Risultato Atteso per Obiettivo Specifico: ${risultatteso.obiettivoStrategico.descrizione}</h3>
<form:form  class="form-horizontal" role ="form" modelAttribute="risultatteso" method="post">
...
<div class="control-group">
	<div class="controls">
	<button type="submit" class="btn btn-medium btn-primary" name="add">Crea Risultato Atteso</button>
...
<p>[view: formRisultattesoCreaSuperGabinetto.jsp 2018/12/04]</p>
