...
<title>Maschera Creazione Priorità Politica</title>
...
<h3 > Nuova PrioritaPolitica per Area ${prioritaPolitica.areaStrategica.descrizione}</h3>
<form:form  class="form-horizontal" role ="form" modelAttribute="prioritaPolitica" method="post">
...
<div class="control-group">
	<div class="controls">
	<button type="submit" class="btn btn-medium btn-primary" name="add">Crea la Priorità Politica</button>
...
<p>[view: formPrioritaPoliticaCreaSuperGabinetto.jsp 2018/01/10]</p>
