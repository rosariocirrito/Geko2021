...
<title>Maschera Modifica Obiettivo Strategico</title>
...
<h3 > Modifica Obiettivo Strategico per Priorità Politica ${obiettivoStrategico.prioritaPolitica.descrizione}</h3>
<form:form  class="form-horizontal" role ="form" modelAttribute="obiettivoStrategico" method="put">
...
<div class="control-group">
	<form:label class="control-label" for="struttureResp" path="struttureResp">Strutture Resp</form:label>
	<div class="controls">
       	<form:textarea class="form-control" path="struttureResp" placeholder="note max 1024 char" maxlength="1024"/>
        <form:errors path="struttureResp" cssClass="error"/> 
	</div>        
</div>
</fieldset>
...
<div class="control-group">
	<div class="controls">
	<button type="submit" class="btn btn-medium btn-primary" name="update">Modifica Obiettivo Strategico</button>
	<button type="submit" class="btn btn-medium btn-primary" name="delete">Cancella Obiettivo Strategico</button>
...
<p>[view: formObiettivoStrategicoUpdateSuperGabinetto.jsp 2018/01/10]</p>
