...
<head>
    ...
    <title>Rendicontazione Obiettivi prioritari per dipartimento</title>
...
<h1 id="titolo-lista">Rendicontazione Obiettivi Prioritari per dipartimento: <em>${struttura} </em>- anno ${anno}</h1>
<hr />  
...
<%@ include file="/WEB-INF/views/common/tableObjsDipartimentaliRend.jsp" %>
...
<table class="footer" >
    ...
    <tr>
      <td>[view: listRendicontazionePrioritariaDipartimentaleController.jsp 2017/05/31] </td>
    </tr>
</table>
</div>
