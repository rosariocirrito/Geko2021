...
<meta charset="ISO-8859-1" />
    <title>Rendicontazione Obiettivi Dipartimentali</title>
...
<h2 > Rendicontazione Obiettivi per dipartimento: <em>${struttura} </em>- anno ${anno}</h2>
...
<div class="col-lg-12 col" >
		<h3>${obj.incarico.denominazioneStruttura} / ${obj.incarico.responsabile}</h3> 
	</div>
</div>
...
<!-- per ogni azione -->
	...
	<div class="row" style="background: lightyellow;">
		...
		<div class="col-lg-7 col"><h4>Descrizione estesa</h4></div>
	...
	<c:forEach items="${act.documenti}" var="docu">
		...
		<div class="row" style="background: lightyellow;">
			...
			<c:if test="${docu.editable}" > 
         	...
         	<div class="col-lg-7 col">${docu.descrizione}</div>
...
<p><span class="label label-warning"><a href="<spring:url value="/ROLE_CONTROLLER" htmlEscape="true" />">Menu Controller</a></span>
    Ge.Ko. by ing. R. Cirrito [listRendicontazioneDipartimentaleController.jsp 2019/06/18] 
</p>
</div>   
</body>
</html>
