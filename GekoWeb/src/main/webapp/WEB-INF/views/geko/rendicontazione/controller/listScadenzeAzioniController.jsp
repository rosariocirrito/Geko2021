...
<h1 id="titolo-lista">Scadenziario azioni per ${struttura} </em>- anno ${anno}</h1>
<hr />  
...
<table class="footer" >
    <tr>
      ...
      Servizio IX Sistemi di elaborazione dati 
      di Palazzo d'Orleans e dei Siti Presidenziali </td>
    </tr>
    <tr>
      <td>[listScadenzeAzioniController.jsp] </td>
    </tr>
</table>
</div>
