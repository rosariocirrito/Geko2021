...
<form:form modelAttribute="documento" method="POST" enctype="multipart/form-data">
    ...
    <fieldset>
	    <h2 class="stato">Lista Documenti Esistenti</h2>
	    <table width="80%">
	    <c:forEach items="${listaDocEsistenti}" var="docItem" varStatus ="status">
	        <tr>
	            <td>${docItem.nomefile}</td>
	        </tr>
	    </c:forEach>
        </table>
    </fieldset>
    ...
    <tr>  
        <td>
           <p class="button"><input type="submit" name="update" value="Modifica Documento"/></p>
        </td>
        <td>
...
<div id="footer">
 ...
 <p><a href="<spring:url value="/ROLE_RESP_POP" htmlEscape="true" />">Menu Resp_POP</a></p>
      Ge.Ko. by Regione Siciliana - ing R. Cirrito </td>
      <p>[view: formDocumentoEditPop.jsp] 2020/12/09</p>  
