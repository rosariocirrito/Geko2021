...
<head>
    ...
    <title>Rendicontazione Obiettivi Apicali Diretti per dipartimento</title>
...
<h1 id="titolo-lista">Rendicontazione Obiettivi Apicali Diretti per dipartimento: <em>${struttura} </em>- anno ${anno}</h1>
<hr />  
...
<table class="footer" >
    ...
    <tr>
      <td>[view: listRendicontazioneDirettaIncaricoApicaleController.jsp 2017/02/22] </td>
    </tr>
</table>
</div>
