...
<h1 id="titolo-lista">Rendicontazione Obiettivi Apicali per dipartimento: <em>${dipartimento} </em>- anno ${anno}</h1>
<hr />  
...
<table class="footer" >
    ...
    <tr>
      <td>[view: listRendicontazioneIncaricoApicaleGab.jsp 2017/05/31] </td>
    </tr>
</table>
</div>
