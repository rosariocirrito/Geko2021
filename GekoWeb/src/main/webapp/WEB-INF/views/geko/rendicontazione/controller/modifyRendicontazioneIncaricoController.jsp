...
<head>
    ...
    <title>Modifica Rendicontazione Obiettivi per: {incarico.order} </title>
...
<h1 id="titolo-lista">Modifica Rendicontazione Obiettivi per: {incarico.order} - anno ${anno}</h1>
<hr />    
...
<%@ include file="/WEB-INF/views/rendicontazione/controller/tableObjsRendMod.jsp" %> 
...
<table class="footer" >
    ...
    <tr>
        <td><p>[view: modifyRendicontazioneIncaricoController.jsp 2017/06/08]</p></td>
    </tr>
  </table>
</div>
</div>
