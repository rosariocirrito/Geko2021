...
<h1 id="titolo-lista">Modifica Rendicontazione Obiettivi Apicali Diretti per <em>${struttura} </em>- anno ${anno}</h1> 
<hr />  
<h4>Responsabile: ${responsabile}</h4>  

<c:if test="${empty listObiettiviDept}">
    <p>Nessun obiettivo apicale diretto trovato per il dipartimento.</p>
</c:if>
