...
<%@ include file="/WEB-INF/views/geko/rendicontazione/manager/tableObjsRend.jsp" %>


    
<!-- Footer -------------------------->
<p><span class="label label-warning"><a href="<spring:url value="/ROLE_MANAGER" htmlEscape="true" />">Menu Manager</a></span>
    Ge.Ko. by ing. R. Cirrito [listRendicontazioneAltroIncaricoManager.jsp 2017/06/27]
