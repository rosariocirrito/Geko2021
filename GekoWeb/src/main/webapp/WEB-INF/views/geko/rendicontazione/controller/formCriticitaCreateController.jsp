...
<h3>
    ...
    Nuova Criticità per ${criticita.azione.descrizione}
    
</h3>



<form:form modelAttribute="criticita" method="post">
...
<table class="footer" >
    <tr>
      ...
      Ge.Ko. by Regione Siciliana - Segreteria Generale - ing R. Cirrito 02/07/2014 </td>
    </tr>
  </table>
