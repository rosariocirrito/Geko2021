...
<head>
    ...
    <title>Modifica Rendicontazione Obiettivi Apicali Diretti </title>
...
<div class="row">
	...
	<h2 >Modifica Rendicontazione Obiettivi Apicali per <em>${struttura} </em>- anno ${anno}</h2>
...
<!-- per ogni azione -->
	<c:forEach items="${obj.azioni}" var="act">   
		...
		<span class="label label-info">
				<a href="<spring:url value="/controllerAct/${act.idAzione}/editRisultatoApicale" htmlEscape="true" />">Aggiungi / Modifica</a>
        </span>
        <br />
        </c:if>
			${act.risultato}
	...
	<div class="row" style="background: lightyellow;">
		...
		<span class="label label-success">
	        <a href="<spring:url value="/controllerDocumenti/new/${act.idAzione}" htmlEscape="true" />">Aggiungi nuovo documento</a>
	        </span>
		</div>
    </div>
	<div class="row" style="background: lightyellow;">
	...
	<c:forEach items="${act.documenti}" var="docu">
		<div class="row" style="background: lightyellow;">
			...
			<c:if test="${docu.editable}" > 
				<span class="label label-success">
              	<a href="<spring:url value="/controllerDocumenti/${docu.id}/editDescrizione" htmlEscape="true" />">Edit nome/descrizione --></a>
              	</span>
            </c:if>	
           	<a href="<spring:url value="/controllerDocumenti/download/${docu.id}" htmlEscape="true" />">${docu.nome} </a>
         	</div>
         	<div class="col-lg-3 col">
         		${docu.descrizione}
         	</div>
         	<div class="col-lg-4 col">
         		<span class="label label-success">
		         	<a href="<spring:url value="/controllerDocumenti/${docu.id}/editFile" htmlEscape="true" />">Edit File --></a>
	         	</span>
	         	${docu.nomefile}
		   	</div>
        </div>
	...
	<div class="row" style="background: orange;">
		<div class="col-lg-12 col">
		<span class="label label-success">
	        <a href="<spring:url value="/controllerCritic/new/${act.idAzione}" htmlEscape="true" />">Aggiungi criticità</a>
	        </span>
		</div>
    </div>
    <c:if test="${!empty act.criticita}">
		<div class="row" style="background: orange;">
			<div class="col-lg-1 col"><h4>ID</h4></div>
			<div class="col-lg-3 col"><h4>criticità</h4></div>
		...
		<c:forEach items="${act.criticita}" var="critic">
			<div class="row" style="background: orange;">
				...
				<div class="col-lg-3 col">
					<span class="label label-success">
              	<a href="<spring:url value="/controllerCritic/${critic.id}/edit" htmlEscape="true" />">Edit --></a>
              	</span>
...
<p><span class="label label-warning"><a href="<spring:url value="/ROLE_CONTROLLER" htmlEscape="true" />">Menu Controller</a></span>
    Ge.Ko. by ing. R. Cirrito [view:modifyRendicontazioneIncaricoApicaleController.jsp 2019/06/19] 
</p>
</div>   
</body>
</html>
