...
<meta charset="ISO-8859-1" />
    <title>Modifica Valutazione del Dirigente Generale</title>
...
<h1 id="titolo-lista">Modifica Valutazione Dirigenziale per <em>${incarico.stringa} </em>- anno ${anno}</h1>
<hr />    
...
<c:if test="${empty lstValutDirig}">
     ...
     <p>oppure pensaci tu! </p>
     <p>
     <a href=<spring:url value="/oivValutazione/new/${incarico.idIncarico}/${anno} "/>">Aggiungi Sezione Comportamenti Organizzativi per ${incarico.responsabile} </a>
	...
	<c:forEach items="${listObiettiviApicali}" var="obj" varStatus ="status">
		...
		<tr>
      		...
      		<tr>
	            ...
	            <th class="prod" width="10%">Valutazione OIV
	            <a href="<spring:url value="/oivOivAzione/newValutOIV/${act.idAzione}" htmlEscape="true" />">Aggiungi</a>
	            </th>           
      		...
      		<tr>    
	            ...
	            <c:forEach items="${act.oivAzione}" var="oivAzione">
		      		<a href="<spring:url value="/oivOivAzione/${oivAzione.id}/editValutOIV" htmlEscape="true" />"> Edit </a>
		      		${oivAzione.valutazioni} </br>	             	
	             </c:forEach>
	            </td>
	            <td><a href="../../../oivAct/${act.idAzione}/editCompletamento/${incarico.idIncarico}">Edit </a>${act.completamento}</td>
...
<hr>
	...
	<tr>
		...
		<th><a href="../../../../oivValutazione/${valutazione.id}/editPesoPianoLavoro/${incarico.idIncarico}">Edit</a>Peso Assegnato</th>
		<th><a href="../../../../oivValutazione/${valutazione.id}/editValutPianoLavoro/${incarico.idIncarico}">Edit</a>Valutazione</th>
		<th>Punteggio</th>
	</tr>
	<tr>
    	<td>Attuazione</td>
...
<table class="footer" >
    ...
    <tr>
      <td>[view:modifyValutazioneIncaricoApicaleOiv.jsp 2017/11/03] </td>
    </tr>
  </table>
</div>
