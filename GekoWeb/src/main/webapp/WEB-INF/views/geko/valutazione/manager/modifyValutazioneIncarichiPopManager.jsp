...
<c:forEach items="${listIncarichiPop}" var="inc" varStatus ="status">
	...
	<c:forEach items="${inc.obiettivi}" var="obj" varStatus ="status">
		...
		<div class="row ">				
    		...
    		<c:forEach items="${obj.azioni}" var="act">
				...
				<a class="btn btn-info" href="<spring:url value="/dirigenteAct/${act.idAzione}/editCompletamento" htmlEscape="true" />"role="button"> Edit </a>${act.completamento}
	...
	<c:forEach items="${inc.valutazioni}" var="valutazione" >	
		<div class="row">
			...
			<div class="col-2 col ">
				<a class="btn btn-info" href="<spring:url value="/managerCompOrgPop/${valutazione.id}/editPesiComportOrgan" htmlEscape="true" />">Edit peso</a> 
			</div>
			<div class="col-2 col ">
				<a class="btn btn-info" href="<spring:url value="/managerCompOrgPop/${valutazione.id}/editValutComportOrgan" htmlEscape="true" />"role="button">Edit Valutazione </a>
			</div>
