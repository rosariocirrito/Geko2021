...
<meta charset="ISO-8859-1" />
    <title>Modifica Valutazione del Dirigente Apicale</title>
		...
		<div class="row">    
   		...
   		<c:forEach items="${obj.azioni}" var="act">
		    <div class="row">    
		        ...
		        <div class="col-1 col">
		        <a class="btn btn-danger" href="<spring:url value="/oivOivAzione/newValutOIV/${act.idAzione}" htmlEscape="true" />" role="button">Aggiungi</a>
            	<hr>
		            <c:forEach items="${act.oivAzione}" var="oivAzione">
			      		<a class="btn btn-info" href="<spring:url value="/oivOivAzione/${oivAzione.id}/edit" htmlEscape="true" />" role="button">Modifica</a>
		       ...
		       <a class="btn btn-info" href="<spring:url value="/oivAct/${act.idAzione}/editCompletamento/${incarico.idIncarico}" htmlEscape="true" />" role="button">Edit</a>
		       ${act.completamento}</div>
...
<div class="row">
	...
	<a class="btn btn-info" href="<spring:url value="/oivValutazione/${valutazione.id}/editValutComportOrgan" htmlEscape="true" />" role="button">Edit</a>
	Valutazione
...
<div class="col-12 col ">
<hr/>
Ge.Ko. by Regione Siciliana - Segreteria Generale - ing. R. Cirrito [modifyValutazioneIncaricoApicaleOiv.jsp] [ultima modifica: 2019/12/06]
<hr/>
</div>
</div>
