...
<meta charset="ISO-8859-1" />
    <title>Naviga Valutazione del Dirigente</title>
...
<body>
<div class="container-fluid" id="wrapCont">
<div class="jumbotron" >
<div class="row">
<div class="col-2" id="wrapCol1" >
...
<li>
<a href="<spring:url value="/controllerValut/navigaValutazioneIncaricoController/${anno}/${incarico.idIncarico}" htmlEscape="true" />">
...
<c:forEach items="${obiettivi}" var="obj" varStatus ="status">
	...
	<c:forEach items="${valutazioni}" var="valutazione" >	
		...
		<div class="row">
			<div class="col-offset-1 col-6 col ">
				Totale Performance Operativa (= 70)
			</div>
			<div class="col-2 col ">
		...
		<div class="row">
			<div class="col-offset-1 col-6 col ">
				Totale Comportamento Organizzativo (= 30)
			</div>
			<div class="col-2 col ">
		...
		<div class="row">
			<div class="col-offset-1 col-6 col ">
				Totale performance individuale
			</div>
			<div class="col-2 col ">
				${valutazione.totPeso}
...
<div class="col-12 col ">
<hr/>
Ge.Ko. by Regione Siciliana - Segreteria Generale - ing. R. Cirrito [${pageName}] [ultima modifica: 2020/02/12]
<hr/>
</div>
</div>
