...
<c:if test="${empty lstValutDirig}">
	...
	<tr>
		...
		<th><a href="../../../gabinettoValutazione/${valutazione.id}/editPesiComportOrgan">Edit</a>Peso Assegnato (5-10)</th>
		<th><a href="../../../gabinettoValutazione/${valutazione.id}/editValutComportOrgan">Edit</a>Valutazione</th>
		<th>Punteggio</th>
	</tr>
	<tr>
...
<table class="footer" >
    ...
    <tr>
	  	<td>[view:modifyValutazioneApicaleGabinetto.jsp 2017/10/11] </td>
	</tr>
  </table>
</div>
