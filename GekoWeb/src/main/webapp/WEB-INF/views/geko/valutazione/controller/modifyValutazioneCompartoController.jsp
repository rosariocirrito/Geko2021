...
<div class="jumbotron" > 
 ...
 <div class="row">
	...
	<c:forEach items="${mapItem.value}" var="assegnazione" varStatus ="status">
		<div class="row rowobj">
			<div class="col-7 colobj"> 
	                 ...
	                 <a class="btn btn-info" href="<spring:url value="/controllerAssegn/${assegnazione.id}/edit" htmlEscape="true" />" role="button">MODIFICA ASSEGNAZIONE </a>
			</div>
			...
			<div class="col-2 colobj">
				<p>
				<a class="btn btn-info" href="<spring:url value="/controllerValutazioneAzioneComparto/${assegnazione.id}/editValutazione" htmlEscape="true" />" role="button">MODIFICA</a>
	            ${assegnazione.valutazione}</p>
			</div>
			<div class="col-2 colobj">
				<p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${assegnazione.punteggio}"/></p>	             
    ...
    <div class="row ">
		...
		<p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${mapItem.key.punteggioAssegnazioni}"/></p>	             
	...
	<c:forEach items="${mapDipendentiValutazioneComparto}" var="map2Item">
		...
		<div class="row">
			...
			<div class="col-2 col ">
				<a class="btn btn-info" href="<spring:url value="/controllerValutazioneComparto/${valutazioneComparto.id}/edit" htmlEscape="true" />"role="button">Edit Valutazione </a>
			</div>
	    	...
	    	<div class="row">
		        ...
		        <div class="col-2 "><p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${valutazioneComparto.competSvolgAttivPunteggio}"/></p></div>	             
	        </div>
	        ...
	        <div class="row">
		        ...
		        <div class="col-2 "><p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${valutazioneComparto.adattContextLavPunteggio}"/></p></div>	             	             
	        </div>
	        ...
	        <div class="row">
		        ...
		        <div class="col-2 "><p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${valutazioneComparto.capacAssolvCompitiPunteggio}"/></p></div>	             	                          
	        </div> 
	         ...
	         <c:if test="${!map2Item.key.catAB}">
	         	<div class="row">
			        ...
			        <div class="col-2 "><p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${valutazioneComparto.innovazPunteggio}"/></p></div>	             	        	             
		        </div> 
		        ...
		        <div class="row">
			        ...
			        <div class="col-2 "><p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${valutazioneComparto.orgLavPunteggio}"/></p></div>	             		             
		        </div> 
	    	...
	    	<div class="row ">
				...
				<div class="col-2 "><p><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${valutazioneComparto.totPunteggio}"/></p></div>	             		             
...
<div class="col-12 col ">
<hr/>
Ge.Ko. by Regione Siciliana - Segreteria Generale - ing. R. Cirrito [modifyValutazioneCompartoController.jsp] [ultima modifica: 2020/04/14]
<hr/>
</div>
</div>
