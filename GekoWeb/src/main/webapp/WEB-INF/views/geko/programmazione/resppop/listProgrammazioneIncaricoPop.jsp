...
<head>
    ...
    <title>Obiettivi del Responsabile Pop</title>
...
<!-- Footer -------------------------->
<p><span class="label label-warning"><a href="<spring:url value="/ROLE_RESP_POP" htmlEscape="true" />">Menu Responsabile POP</a></span>
    Ge.Ko. by ing. R. Cirrito [listProgrammazioneIncaricoPop.jsp 2020/12/07] 
</div>
</div>
</div>
