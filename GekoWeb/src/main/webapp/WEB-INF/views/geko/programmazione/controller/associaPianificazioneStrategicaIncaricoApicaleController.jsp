...
<c:forEach items="${listObiettivi}" var="obj" varStatus ="status">
	...
	<td>
		...
		<a href="<spring:url value="/controllerAssocia/${associaz.id}/edit/${idIncaricoApicale}" htmlEscape="true" />">MODIFICA </a>
...
<table class="footer" >
    ...
    <tr>
      <td>[view: associaPianificazioneStrategicaIncaricoApicaleController.jsp 2017/09/19] </td>
    </tr>
</table>
</div>
