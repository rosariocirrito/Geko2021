...
<h3 > Nuovo Outcome per Obiettivo Strategico per ${outcome.obiettivoStrategico.descrizione}</h3>
<form:form  class="form-horizontal" role ="form" modelAttribute="outcome" method="post">
...
<div class="control-group">
	...
	<div class="controls">
       	<form:textarea class="form-control" path="descrizione" placeholder="max 250 char" maxlength="512"/>
...
<div class="control-group">
	<div class="controls">
	<button type="submit" class="btn btn-medium btn-primary" name="add">Crea outcome</button>
...
<p>[view: formOutcomeCreaSuperGabinetto.jsp 2018/01/16]</p>
