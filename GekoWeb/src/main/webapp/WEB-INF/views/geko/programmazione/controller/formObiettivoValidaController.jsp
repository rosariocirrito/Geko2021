...
<fieldset>
    ...
    <table  width="80%">
        <tr>
            <td colspan="2">
                <p class="button"><input type="submit" name="update" value="Aggiorna Validazione Obiettivo"/></p>
            </td>
            <td>
            <p class="button"><input type="submit" name="cancel" value="Rinuncia Validazione Obiettivo"/></p>
            </td>
        </tr>
    </table>  
</fieldset>
...
<table class="footer" >
    <tr>
      ...
      Ge.Ko. by Regione Siciliana - Segreteria Generale - ing. R. Cirrito 2019/04/26 
      </td>
    </tr>
    <tr>
        <td><p>[view: formObiettivoValidaController.jsp]</p></td>
    </tr>
  </table>
