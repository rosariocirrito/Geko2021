...
<head>
    ...
    <title>Lista Programmazione Obiettivi Pop del Dipartimento</title>
...
<c:if test="${empty listIncarichiDept}">
     <p>Nessun incarico pop trovato.</p>
</c:if>
...
<table class="footer" >
    ...
    <tr>
	  	<td>[view:listProgrammazioneCompattaPopDipartimentoController.jsp by R. Cirrito 2021/05/06] </td>
	</tr>
</table>
</div>
</div>
