...
<html lang="it">
    ...
    <meta charset="ISO-8859-1" />
        <title>Maschera Proposizione Obiettivo</title>
...
<form:form  modelAttribute="obiettivo" method="${method}">
    ...
    <fieldset>
        ...
        <table  width="80%">
            <tr>
	            <td colspan="3">
	                <p class="button"><input type="submit" name="update" value="Proponi Obiettivo"/></p>
	            </td>
	            <td>
	            	<p class="button"><input type="submit" name="cancel" value="Rinuncia alla proposta"/></p>
	            </td>
	      	</tr>
    	</table>  
    </fieldset>
...
<table class="footer" >
    <tr>
      ...
      Ge.Ko. by ing. R. Cirrito
      </td>
    </tr>
    <tr>
        <td><p>[view: formObiettivoProponiPop.jsp 2020/12/07]</p></td>
    </tr>
  </table>
