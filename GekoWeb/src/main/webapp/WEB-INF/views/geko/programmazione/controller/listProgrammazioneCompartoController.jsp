...
<head>
    ...
    <title>Lista Programmazione Dipendenti comparto</title>
...
<c:forEach items="${mapDipendentiAssegnazioni}" var="mapItem">
 <c:set var= "esisteGia" value="false" />
    ...
    <table class="table table-bordered table-striped">
	    ...
	    <c:if test="${!esisteGia}">
	    <p><a href="<spring:url value="/controllerCompOrgComparto/new/${mapItem.key.idPersona}/${anno}/${idIncarico}" htmlEscape="true" />">Aggiungi Comportamenti Organizzativi per ${mapItem.key.stringa} </a>
	   </p>           
...
<p><span class="label label-warning"><a href="<spring:url value="/ROLE_CONTROLLER" htmlEscape="true" />">Menu Controller</a></span>
    Ge.Ko. by ing. R. Cirrito [view:listProgrammazioneCompartoController.jsp 2020/04/14] 
