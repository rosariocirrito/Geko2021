...
<head>
    ...
    <title>Associa Comparto a Obiettivi della Struttura del Dirigente</title>
...
<section>   
<h1 id="titolo-lista">Associa Comparto a Programmazione Obiettivi per <em>${struttura} </em>- anno ${anno}</h1>
<hr />    
...
<p><span class="label label-warning"><a href="<spring:url value="/ROLE_MANAGER" htmlEscape="true" />">Menu Manager</a></span>
    Ge.Ko. by ing. R. Cirrito [view: associaCompartoProgrammazioneIncaricoManager.jsp 2019/08/23]
