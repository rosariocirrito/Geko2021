...
<title>Maschera Modifica Obiettivo Comparto</title>
...
<div class="control-group">
<p class="control-label">Descrizione proposta</p>
<p class="controls">${obiettivo.descrizioneProp}</p>
</div>
...
<p>[view: formObiettivoEditComparto.jsp 2019/04/26]</p>      
</form:form>         
