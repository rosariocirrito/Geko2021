...
<html lang="it">
    ...
    <meta charset="ISO-8859-1" />
        <title>Maschera Definizione Obiettivo Comparto</title>
...
<form:form  modelAttribute="obiettivo" method="${method}">
    ...
    <fieldset>
        ...
        <table  width="80%">
        	<tr>
	            <td colspan="3">
	                <p class="button"><input type="submit" name="update" value="Rendi Definitivo l'obiettivo"/></p>
	            </td>
           		<td>
...
<table class="footer" >
    ...
    <tr>
        <td><p>[view: formObiettivoDefCompartoManager.jsp 10/12/2019]</p></td>
    </tr>
  </table>
