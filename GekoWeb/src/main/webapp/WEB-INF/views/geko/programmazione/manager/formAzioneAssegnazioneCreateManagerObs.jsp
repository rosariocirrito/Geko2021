...
<table width="80%">
    <tr>
        ...
        <td><form:input path="dataInizio" size="10" maxlength="10"/> (gg/mm/anno)</td>
        <td><form:errors path="dataInizio" cssClass="errors"/></td>
    </tr>
    <tr>
        <td><form:label for="dataFine" path="dataFine">dataFine</form:label></td>
        <td><form:input path="dataFine" size="10" maxlength="10"/> (gg/mm/anno)</td>
...
<table class="footer" >
    ...
    <tr>
        <td><p>[view: formAzioneAssegnazioneCreateManager.jsp]</p></td>
    </tr>
</table>
