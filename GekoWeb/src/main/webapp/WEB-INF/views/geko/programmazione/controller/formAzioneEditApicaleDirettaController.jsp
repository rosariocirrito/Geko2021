...
<ul>
	...
	<li>
    	<form:label for="scadenzaApicale" path="scadenzaApicale">ScadenzaApicale</form:label>
		...
		<li>
	    	<form:label for="pesoApicale" path="pesoApicale">Peso</form:label>
...
<ul>
	<li>    
	   ...
	   <input type="submit" name="delete" value="Cancella Azione Apicale"/>
	</li>
	<li>   
...
<p>Ge.Ko by - ing. R. Cirrito [view: formAzioneEditApicaleDirettaController.jsp 2019/04/17]</p>
