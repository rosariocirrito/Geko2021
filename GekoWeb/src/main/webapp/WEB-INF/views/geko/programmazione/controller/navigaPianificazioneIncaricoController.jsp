...
<div class="row">
<div class="col-lg-2" id="wrapCol1" >
...
<li>
<a href="<spring:url value="/controller/navigaPianificazioneIncaricoController/${anno}/${incarico.idIncarico}" htmlEscape="true" />">
...
<div class="col-lg-10" id="wrapCol2" >
    

<article>
<section id="obj-sezione">   
<h1 id="titolo-lista">Programmazione Obiettivi per incarico: <em>${incarico.stringa} </em>- anno ${anno}</h1>
<hr />  
...
<table class="footer" >
    ...
    <tr>
      <td>[view: navigaPianificazioneIncaricoController.jsp 24/09/2019] </td>
    </tr>
</table>
</div>
