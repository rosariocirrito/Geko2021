...
<html lang="it">
    ...
    <meta charset="ISO-8859-1" />
        <title>Modifica Completamento Azione Apicale</title>
...
<h2>Modifica Completamento Azione Apicale</h2>
...
<fieldset>
    ...
    <tr>
        <td><form:label for="scadenza" path="scadenza">Scadenza Apicale</form:label></td>
        <td><fmt:formatDate value="${azione.scadenzaApicale}" pattern="dd/MM/yyyy"/></td>
    </tr>
    
    <tr>
        <td ><form:label for="peso" path="peso">Peso Apicale</form:label></td>
        <td>${azione.pesoApicale}</td>
    </tr>
...
<table width="80%">
    ...
    <tr>
        <security:authorize ifAnyGranted="ROLE_SEPICOS">
...
<table class="footer" >
    ...
    <tr>
        <td><p>[view: formAzioneCompletamentoSepicos.jsp 2016/04/22]</p></td>
    </tr>
  </table>
