	   		...
	   		<c:forEach items="${prio.obiettiviStrategici}" var="objStrat" varStatus ="statusObj">
		        <div class="row">
					...
					<div class="col-10 col" style="background: lightblue;">
						<p>
						<a href="<spring:url value="/superGabObiettivoStrategico/${objStrat.id}/edit" htmlEscape="true" />" class="btn btn-info">Modifica</a>
				...
				<c:forEach items="${objStrat.outcomes}" var="outcome" varStatus ="statusObj">
	                <div class="row">
		                <div class="col-5 col-offset-2">
							<p>
							<a href="<spring:url value="/superGabOutcome/${outcome.id}/edit" htmlEscape="true" />">Modifica</a>
