...
<meta charset="ISO-8859-1" />
    <title>Maschera Clonazione Obiettivo</title>
...
<h2 > Clona programmazione su anno successivo</h2>
...
<table width="80%">
   <tr>
       <td width="20%"><form:label for="codice" path="codice">Codice (es. RICH_1)</form:label></td>
...
<ul>
	<li>
	    <input type="submit" name="add" value="Clona l'obiettivo"/>  
...
<p>[view: formObiettivoApicaleClonaController.jsp 2020/01/14]</p>
