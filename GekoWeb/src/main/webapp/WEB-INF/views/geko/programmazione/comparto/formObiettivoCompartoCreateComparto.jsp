...
<title>Maschera Creazione Obiettivo Comparto</title>
...
<h3 > Nuova programmazione di comparto per anno ${obiettivo.anno}</h3>
...
<div class="control-group">
	...
	<div class="controls">
       	<form:input class="form-control" path="codice" placeholder="COMP_1" maxlength="16"/>
...
<p>[view: formObiettivoCompartoCreateComparto.jsp by ing. R. Cirrito 2019/08/26]</p>
