...
<head>
    ...
    <title>Modifica Programmazione Dipendenti comparto</title>
...
<c:if test="${empty mapDipendentiAssegnazioni}">
    <p>Nessuna assegnazione di dipendenti trovata !</p>
</c:if>
...
<c:forEach items="${mapDipendentiAssegnazioni}" var="mapItem">
 <c:set var= "esisteGia" value="false" />
    ...
    <table class="table table-bordered table-striped">
	    ...
	    <tr>
	        <th>Obiettivo <span class="label label-info"><a href="<spring:url value="/controllerObj/newComparto/${anno}/${idIncarico}" htmlEscape="true" />">Crea obiettivo di gruppo o individuale</a></span>
	        </th>
	        <th>Azione</th>
	        <th>Peso </th>
	    </tr>
	    ...
	    <c:forEach items="${mapItem.value}" var="assegnazione" varStatus ="status">
	         <tr>
	            ...
	            <td >${assegnazione.azione.descrizione} 	                 
	             ...
	             <td>	             
	             	<a href="<spring:url value="/controllerAssegn/${assegnazione.id}/editComparto" htmlEscape="true" />">MODIFICA</a>
	                 ${assegnazione.peso}
	             </td>
	         </tr>	         
	    ...
	    <c:forEach items="${map2Item.value}" var="valutazioneComparto" varStatus ="status">
		    ...
		    <tr>
		    	<th>Indicatore</th>
		        <th>Peso <a href="<spring:url value="/controllerCompOrgComparto/${valutazioneComparto.id}/editPesiComportOrgan" htmlEscape="true" />">MODIFICA </a>
		           </th>
		    </tr>
			</thead>
	        <tr>
...
<p><span class="label label-warning"><a href="<spring:url value="/ROLE_CONTROLLER" htmlEscape="true" />">Menu Controller</a></span>
    Ge.Ko. by ing. R. Cirrito [view:modifyProgrammazioneCompartoController.jsp 2020/04/10] 
