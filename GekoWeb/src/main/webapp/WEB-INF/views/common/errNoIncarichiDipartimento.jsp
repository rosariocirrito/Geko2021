...
<h2 > Non riesco a trovare nessun incarico dirigenziale per il tuo dipartimento per l'anno in questione</h2>
...
<table class="footer" >
    ...
    <tr>
      <td>[errNoIncarichiDipartimento.jsp] 2020/01/27</td>
    </tr>
</table>
</div>   
