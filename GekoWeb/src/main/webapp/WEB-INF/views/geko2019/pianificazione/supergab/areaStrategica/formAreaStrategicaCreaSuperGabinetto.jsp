...
<title>Maschera Creazione Area Strategica</title>
...
<h3 > Nuova Area Strategica per anno ${areaStrategica.anno}</h3>
...
<div class="control-group">
	...
	<div class="controls">
       	<form:input class="form-control" path="codice" placeholder="A" maxlength="8"/>
...
<div class="control-group">
	<div class="controls">
	<button type="submit" class="btn btn-medium btn-primary" name="add">Crea l'area Strategica</button>
...
<p>[view: formAreaStrategicaCreaSuperGabinetto.jsp 2019/04/17]</p>
