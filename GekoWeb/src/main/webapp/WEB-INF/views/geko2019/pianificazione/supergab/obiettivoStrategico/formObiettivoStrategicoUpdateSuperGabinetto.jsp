...
<h3 > Modifica Obiettivo Strategico per Area Strategica ${obiettivoStrategico.areaStrategica.descrizione}</h3>
<form:form  class="form-horizontal" role ="form" modelAttribute="obiettivoStrategico" method="put">
	...
	<fieldset>
		...
		<div class="control-group">
			<form:label class="control-label" for="codice" path="descrizione">Codice</form:label>
			<div class="controls">
		       	<form:textarea class="form-control" path="codice" placeholder="codice" maxlength="16"/>
...
<p>[view: formObiettivoStrategicoUpdateSuperGabinetto.jsp 2019/04/16]</p>
