...
<h3 > Nuovo Obiettivo Strategico per Area ${obiettivoStrategico.areaStrategica.descrizione}</h3>
...
<p>[view: formObiettivoStrategicoCreaSuperGabinetto.jsp 2019/04/16]</p>
