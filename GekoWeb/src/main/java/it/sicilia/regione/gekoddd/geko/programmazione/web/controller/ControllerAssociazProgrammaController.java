...
@RequestMapping("/controllerAssociaProgramma")
public class ControllerAssociazProgrammaController  {
	
	private Log log = LogFactory.getLog(ControllerAssociazProgrammaController.class);
    ...
    public ControllerAssociazProgrammaController() { }
    ...
    public String updateForm(@PathVariable("id") int id, @PathVariable("idIncaricoApicale") int idIncaricoApicale, Model model) {
        ...
        return "geko/programmazione/controller/formAssociazProgrammaEditController";
	}
    ...
    public String processUpdateSubmit(@ModelAttribute AssociazProgramma associazProgramma, 
		...
		if (result.hasErrors()) {
            ...
            this.controllerServizi.controllerUpdateAssociazProgramma(associazProgramma);
            status.setComplete();
            return "redirect:/controller/associaProgrammaIncaricoApicaleController/"+
    ...
    public String processDeleteSubmit(@ModelAttribute AssociazProgramma associazProgramma, 
                                BindingResult result, 
                                SessionStatus status) {
        this.controllerServizi.controllerDeleteAssociazProgramma(associazProgramma);
        //
        return "redirect:/controller/associaProgrammaIncaricoApicaleController/"+
        menu.getAnno()+"/"+associazProgramma.getApicale().getIdIncaricoApicale();  }
    ...
    public String createAssociazProgrammaGet(@PathVariable("idObiettivo") int idObiettivo,
        ...
        return "geko/programmazione/controller/formAssociazProgrammaCreateController";
    }
	...
	new AssociazProgrammaValidator().validate(associazProgramma, result);
        if (result.hasErrors()) {
        	...
        	associazProgramma.setProgramma(programma);        	
            this.controllerServizi.controllerCreateAssociazProgramma(associazProgramma);
            status.setComplete();
