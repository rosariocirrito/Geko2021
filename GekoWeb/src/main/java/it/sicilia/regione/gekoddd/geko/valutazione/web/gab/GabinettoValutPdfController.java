...
@Controller
@RequestMapping("/gabValutPdf")
public class GabinettoValutPdfController  {
	//
    @Autowired
    ...
    //
    public GabinettoValutPdfController() { }
    ...
    */
    ...
    @RequestMapping(value="pdfValutazioneIncaricoGabConCalcolo/{anno}/{idIncarico}")
