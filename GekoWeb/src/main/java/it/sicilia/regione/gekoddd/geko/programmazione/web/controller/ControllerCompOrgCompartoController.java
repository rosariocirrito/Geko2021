...
@RequestMapping("/controllerCompOrgComparto")
public class ControllerCompOrgCompartoController  {
    
	private Log log = LogFactory.getLog(ControllerCompOrgCompartoController.class);
    ...
    public ControllerCompOrgCompartoController() { }
 ...
 // crea Comportamento Organizzativo su incarico
    ...
    public String getNewComportOrgan(
    	...
    	if(dip.isCatAB()) return "geko/programmazione/controller/formCompOrgABCompartoCreateController";        	
        else return "geko/programmazione/controller/formCompOrgCDCompartoCreateController";
    ...
    public String postNewComportOrgan(@ModelAttribute ValutazioneComparto valutazioneComparto, 
        ...
        if (result.hasErrors()) {
        	if(dip.isCatAB()) return "geko/programmazione/controller/formCompOrgABCompartoCreateController";	        		
	            ...
	            this.controllerValutazioneServizi.controllerCreateValutazioneComparto(valutazioneComparto);
	            status.setComplete();
	            ...
	            if(inc.incaricoDipartimentale) {
	            	return "redirect:/controller/modifyCompartoProgrammazione/"+valutazioneComparto.getAnno()+"/"+valutazioneComparto.getIncaricoID();
 ...
 // ------------------------- Pesi Comportamenti Organizzativi -------------------------------------------------
    ...
    public String putEditPesiComportOrgan(@ModelAttribute ValutazioneComparto valutazione, 
		...
		if (result.hasErrors()) {
            ...
            this.controllerValutazioneServizi.controllerUpdateValutazioneComparto(valutazione);
            status.setComplete();
            return "redirect:/controller/modifyCompartoProgrammazione/"+valutazione.getAnno()
