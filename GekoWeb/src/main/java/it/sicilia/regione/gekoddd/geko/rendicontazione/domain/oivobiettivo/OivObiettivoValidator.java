 ...
 * @author rc
 */
public class OivObiettivoValidator {

	public void validate(OivObiettivo oivObiettivo, Errors errors) {
            if (!StringUtils.hasLength(oivObiettivo.getMemo())) {
			errors.rejectValue("memo", "required", "required");
		} /*
