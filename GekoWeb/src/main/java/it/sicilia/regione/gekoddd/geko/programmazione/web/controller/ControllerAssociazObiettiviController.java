...
@RequestMapping("/controllerAssocia")
public class ControllerAssociazObiettiviController  {
    ...
    public ControllerAssociazObiettiviController() { }
    ...
    public String updateForm(@PathVariable("id") int id, @PathVariable("idIncaricoApicale") int idIncaricoApicale, Model model) {
		...
		//if (dipartimento.equals(associazObiettivi.getApicale().getDipartimento())){
	            ...
	            return "geko/programmazione/controller/formAssociazObiettiviEditController";
	      //  }
    ...
    public String processUpdateSubmit(@ModelAttribute AssociazObiettivi associazObiettivi, 
		...
		if (result.hasErrors()) {
            ...
            this.controllerServizi.controllerUpdateAssociazObiettivi(associazObiettivi);
            status.setComplete();
            return "redirect:/controller/associaPianificazioneStrategicaIncaricoApicaleController/"+
    ...
    public String processDeleteSubmit(@ModelAttribute AssociazObiettivi associazObiettivi, 
                                BindingResult result, 
                                SessionStatus status) {
        this.controllerServizi.controllerDeleteAssociazObiettivi(associazObiettivi);
        //
        return "redirect:/controller/associaPianificazioneStrategicaIncaricoApicaleController/"+
        menu.getAnno()+"/"+associazObiettivi.getApicale().getIdIncaricoApicale();  }
    ...
    public String createAssociazObiettiviGet(@PathVariable("idObiettivo") int idObiettivo,
        ...
        Map<Integer,String> mapSelectObjStrateg = obiettiviStrategiciQryServizi.mapSelectObiettiviStrategici(apicale.getAnno()); 
        ...
        return "geko/programmazione/controller/formAssociazObiettiviCreateController";
    }
