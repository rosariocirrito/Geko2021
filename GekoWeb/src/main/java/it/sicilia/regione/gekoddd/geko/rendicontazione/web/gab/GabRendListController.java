package it.sicilia.regione.gekoddd.geko.rendicontazione.web.gab;
...
@Controller
@RequestMapping("/gabRend")
public class GabRendListController  {
	
	private Log log = LogFactory.getLog(GabRendListController.class);
 ...
 // lista obiettivi e azioni apicali
    @RequestMapping(value="listRendicontazioneIncaricoApicaleGab/{anno}/{idIncarico}", method = RequestMethod.GET)
    public String listRendicontazioneIncaricoApicaleSepicosGet(
        ...
        //
        String pageName = "geko/rendicontazione/gab/listRendicontazioneIncaricoApicaleGab";
 ...
 // --------- scadenzario --------------------------
    ...
    public String scadenze(@PathVariable("anno") int anno, @PathVariable("idIncarico") int idIncarico,Model model) {
    	...
    	//
        return "geko/rendicontazione/gab/listScadenzeAzioniGabinetto";
