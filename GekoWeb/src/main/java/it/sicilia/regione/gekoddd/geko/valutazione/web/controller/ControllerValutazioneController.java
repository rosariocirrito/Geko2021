...
@RequestMapping("/controllerValutazione")
public class ControllerValutazioneController  {
    ...
    public ControllerValutazioneController() { }
    ...
    public String processDeleteSubmit(@ModelAttribute Valutazione valutazione, 
                                BindingResult result, 
                                SessionStatus status) {
        this.controllerServizi.controllerDeleteValutazione(valutazione);
        return "redirect:/controllerIncarico/" + valutazione.getIncarico().getIdIncarico();
    ...
    public String processSubmitComportOrganController(@ModelAttribute Valutazione valutazione, 
		...
		//
	        if (result.hasErrors()) {
	            return "geko/valutazione/controller/formValutazioneCreateController";
	        }	
		else {
	            this.controllerServizi.controllerCreateValutazione(valutazione);
	            status.setComplete();
	            return "redirect:/controllerValut/modifyValutazioneIncaricoController/"+valutazione.getAnno()+"/"+valutazione.getIncaricoID();
		}
    }
    ...
    public String updateFormPesiComportOrgan(@PathVariable("id") int id, Model model) {
        ...
        //
        model.addAttribute("valutazione", valutazione);
        return "geko/valutazione/controller/formPesiComportOrganEditController";
    ...
    public String processUpdateSubmitPesiComportOrgan(@ModelAttribute Valutazione valutazione, 
		...
		if (result.hasErrors()) {
            ...
            this.controllerServizi.controllerUpdateValutazione(valutazione);
            status.setComplete();
            return "redirect:/controllerValut/modifyValutazioneIncaricoController/"+valutazione.getAnno()
    ...
    public String updateFormValutComportOrgan(@PathVariable("id") int id, Model model) {
        ...
        //
        model.addAttribute("valutazione", valutazione);
        return "geko/valutazione/controller/formValutComportOrganEditController";
